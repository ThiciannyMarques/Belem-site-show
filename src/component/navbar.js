...
const navigation = [
  ...
  { name: 'Culinaria', href: '../culinaria', current: false },
...
export default function Example() {
  return (
    <Disclosure as="nav" className="bg-gray-600 bg-opacity-50 shadow-2xl">
      {({ open }) => (
        <>
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? 'bg-gray-900 text-black bg-opacity-40' : 'text-black-300 hover:bg-gray-700 hover:text-white hover:bg-opacity-40',
